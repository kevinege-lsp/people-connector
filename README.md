...
```bash
.venv/bin/people-connector init          # writes a starter roster.csv
$EDITOR roster.csv                       # put your people in it
.venv/bin/people-connector preview       # see this week's matches, write nothing
.venv/bin/people-connector run           # commit them, write the output files
```
...
Coverage is the number this exists to move. `stats --person ada@akamai.com`
